// САФТ "Рубеж" — XDP-фильтр сетевых пакетов
// Модуль ядра: высокопроизводительная фильтрация пакетов на уровне драйвера NIC с динамической конфигурацией через BPF-карты
