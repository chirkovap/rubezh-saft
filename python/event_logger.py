#!/usr/bin/env python3
"""
XDPGuard Event Logger

Хранит события безопасности в памяти для отображения в веб-интерфейсе (SIEM-like)
"""
...
class EventLogger:
    ...
    def clear(self):
        ...
        logger.info(f"EventLogger cleared ({count} events removed)")
        return count
